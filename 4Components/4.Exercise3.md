...
<td style="border: 1px solid darkorange">City Parks (MapInfo TAB)<br>Walking Trail (CSV)<br>Food Vendors/Water Fountains (File Geodatabase)<br>Car Parking (OpenStreetMap)</td>
</tr>
...
<br>**5) Clip DrinkingFountains Data**
<br>The drinking fountains data, too, covers the entire city and should be clipped to size. As with the car parks, direct the DrinkingFountains feature type into the Clipper:Clippee port:

![](./Images/Img4.83.Ex3.ClipDrinkingFountains.png)


<br>**6) Run Workspace**
<br>Again, run the workspace to ensure the result is what we are expecting.
...
Again you'll get the pop-up dialog. Again you can ignore it. It's covered in the next section of this chapter.
</span>
</td>
</tr>
</table>
